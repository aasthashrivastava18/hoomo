...
exports.register = async (req, res) => {
  try {
    ...
    user = new User({
      ...
      phone,
      address,
      isVerified: true // For simplicity, auto-verify regular users
    });
...
exports.login = async (req, res) => {
  try {
    ...
    if (user.role === 'vendor' && !user.isVerified) {
      return res.status(400).json({ message: 'Your vendor account is pending approval' });
    }
...
exports.registerVendor = async (req, res) => {
  try {
    ...
    user = new User({
      ...
      address,
      role: 'vendor',
      isVerified: false, // Vendors need approval
      businessName,
      businessType
    });
